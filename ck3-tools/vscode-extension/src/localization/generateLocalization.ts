...
function getFileType(filePath: string): string | null {
  if (filePath.includes('/common/traits/')) return 'trait';
  if (filePath.includes('/common/buildings/')) return 'building';
  if (filePath.includes('/common/decisions/')) return 'decision';
