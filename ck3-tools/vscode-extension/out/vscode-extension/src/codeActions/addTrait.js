    ...
    const disposable = vscode.commands.registerCommand('ck3-tools.addTrait', async () => {
        ...
        try {
            ...
            if (template === 'personality_trait') {
                const primaryStat = await vscode.window.showQuickPick(['diplomacy', 'martial', 'stewardship', 'intrigue', 'learning', 'prowess'], {
                ...
                const secondaryStat = await vscode.window.showQuickPick(['none', 'diplomacy', 'martial', 'stewardship', 'intrigue', 'learning', 'prowess'], {
                ...
                const primaryStat = await vscode.window.showQuickPick(['diplomacy', 'martial', 'stewardship', 'intrigue', 'learning'], {
                    placeHolder: 'Select primary stat',
                    title: 'Primary Stat'
                });
                if (!primaryStat)
                ...
                const lifestyle = await vscode.window.showQuickPick(['diplomacy', 'martial', 'stewardship', 'intrigue', 'learning'], {
