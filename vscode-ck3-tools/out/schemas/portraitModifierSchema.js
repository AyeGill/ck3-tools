...
exports.portraitModifierSchemaMap = exports.portraitModifierSchema = void 0;
exports.getPortraitModifierFieldNames = getPortraitModifierFieldNames;
exports.getPortraitModifierFieldDocumentation = getPortraitModifierFieldDocumentation;
exports.portraitModifierSchema = [
    // Basic Properties
    {
        name: 'usage',
        type: 'enum',
...
exports.portraitModifierSchemaMap = new Map(exports.portraitModifierSchema.map((field) => [field.name, field]));
function getPortraitModifierFieldNames() {
    return exports.portraitModifierSchema.map((field) => field.name);
}
function getPortraitModifierFieldDocumentation(fieldName) {
    const field = exports.portraitModifierSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=portraitModifierSchema.js.map