...
exports.holdingTypeSchemaMap = exports.holdingTypeSchema = void 0;
exports.getHoldingTypeFieldNames = getHoldingTypeFieldNames;
exports.getHoldingTypeFieldDocumentation = getHoldingTypeFieldDocumentation;
exports.holdingTypeSchema = [
    // Basic Properties
    {
        name: 'primary',
        type: 'boolean',
...
exports.holdingTypeSchemaMap = new Map(exports.holdingTypeSchema.map((field) => [field.name, field]));
function getHoldingTypeFieldNames() {
    return exports.holdingTypeSchema.map((field) => field.name);
}
function getHoldingTypeFieldDocumentation(fieldName) {
    const field = exports.holdingTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=holdingTypeSchema.js.map