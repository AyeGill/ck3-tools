...
exports.culturePillarSchemaMap = exports.culturePillarSchema = void 0;
exports.getCulturePillarFieldNames = getCulturePillarFieldNames;
exports.getCulturePillarFieldDocumentation = getCulturePillarFieldDocumentation;
exports.culturePillarSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.culturePillarSchemaMap = new Map(exports.culturePillarSchema.map((field) => [field.name, field]));
function getCulturePillarFieldNames() {
    return exports.culturePillarSchema.map((field) => field.name);
}
function getCulturePillarFieldDocumentation(fieldName) {
    const field = exports.culturePillarSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=culturePillarSchema.js.map