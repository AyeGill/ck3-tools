...
exports.travelDangerTypeSchemaMap = exports.travelDangerTypeSchema = void 0;
exports.getTravelDangerTypeFieldNames = getTravelDangerTypeFieldNames;
exports.getTravelDangerTypeFieldDocumentation = getTravelDangerTypeFieldDocumentation;
exports.travelDangerTypeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.travelDangerTypeSchemaMap = new Map(exports.travelDangerTypeSchema.map((field) => [field.name, field]));
function getTravelDangerTypeFieldNames() {
    return exports.travelDangerTypeSchema.map((field) => field.name);
}
function getTravelDangerTypeFieldDocumentation(fieldName) {
    const field = exports.travelDangerTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=travelDangerTypeSchema.js.map