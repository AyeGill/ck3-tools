...
exports.deathreasonsSchemaMap = exports.deathreasonsSchema = void 0;
exports.getDeathreasonsFieldNames = getDeathreasonsFieldNames;
exports.getDeathreasonsFieldDocumentation = getDeathreasonsFieldDocumentation;
exports.deathreasonsSchema = [
    // Basic Properties
    {
        name: 'icon',
        type: 'string',
...
exports.deathreasonsSchemaMap = new Map(exports.deathreasonsSchema.map((field) => [field.name, field]));
function getDeathreasonsFieldNames() {
    return exports.deathreasonsSchema.map((field) => field.name);
}
function getDeathreasonsFieldDocumentation(fieldName) {
    const field = exports.deathreasonsSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=deathreasonsSchema.js.map