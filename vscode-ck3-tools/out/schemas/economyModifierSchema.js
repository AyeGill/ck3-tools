...
exports.economyModifierSchemaMap = exports.economyModifierSchema = void 0;
exports.getEconomyModifierFieldNames = getEconomyModifierFieldNames;
exports.getEconomyModifierFieldDocumentation = getEconomyModifierFieldDocumentation;
exports.economyModifierSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.economyModifierSchemaMap = new Map(exports.economyModifierSchema.map((field) => [field.name, field]));
function getEconomyModifierFieldNames() {
    return exports.economyModifierSchema.map((field) => field.name);
}
function getEconomyModifierFieldDocumentation(fieldName) {
    const field = exports.economyModifierSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=economyModifierSchema.js.map