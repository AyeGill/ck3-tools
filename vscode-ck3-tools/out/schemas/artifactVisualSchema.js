...
exports.artifactVisualSchemaMap = exports.artifactVisualSchema = void 0;
exports.getArtifactVisualFieldNames = getArtifactVisualFieldNames;
exports.getArtifactVisualFieldDocumentation = getArtifactVisualFieldDocumentation;
exports.artifactVisualSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.artifactVisualSchemaMap = new Map(exports.artifactVisualSchema.map((field) => [field.name, field]));
function getArtifactVisualFieldNames() {
    return exports.artifactVisualSchema.map((field) => field.name);
}
function getArtifactVisualFieldDocumentation(fieldName) {
    const field = exports.artifactVisualSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=artifactVisualSchema.js.map