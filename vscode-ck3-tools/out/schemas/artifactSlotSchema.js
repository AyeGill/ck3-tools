...
exports.artifactSlotSchemaMap = exports.artifactSlotSchema = void 0;
exports.getArtifactSlotFieldNames = getArtifactSlotFieldNames;
exports.getArtifactSlotFieldDocumentation = getArtifactSlotFieldDocumentation;
exports.artifactSlotSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.artifactSlotSchemaMap = new Map(exports.artifactSlotSchema.map((field) => [field.name, field]));
function getArtifactSlotFieldNames() {
    return exports.artifactSlotSchema.map((field) => field.name);
}
function getArtifactSlotFieldDocumentation(fieldName) {
    const field = exports.artifactSlotSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=artifactSlotSchema.js.map