...
exports.dnaDataSchemaMap = exports.dnaDataSchema = void 0;
exports.getDnaDataFieldNames = getDnaDataFieldNames;
exports.getDnaDataFieldDocumentation = getDnaDataFieldDocumentation;
exports.dnaDataSchema = [
    // Basic Properties
    {
        name: 'portrait_info',
        type: 'block',
...
exports.dnaDataSchemaMap = new Map(exports.dnaDataSchema.map((field) => [field.name, field]));
function getDnaDataFieldNames() {
    return exports.dnaDataSchema.map((field) => field.name);
}
function getDnaDataFieldDocumentation(fieldName) {
    const field = exports.dnaDataSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=dnaDataSchema.js.map