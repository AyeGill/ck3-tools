...
exports.mapModeSchemaMap = exports.mapModeSchema = void 0;
exports.getMapModeFieldNames = getMapModeFieldNames;
exports.getMapModeFieldDocumentation = getMapModeFieldDocumentation;
exports.mapModeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.mapModeSchemaMap = new Map(exports.mapModeSchema.map((field) => [field.name, field]));
function getMapModeFieldNames() {
    return exports.mapModeSchema.map((field) => field.name);
}
function getMapModeFieldDocumentation(fieldName) {
    const field = exports.mapModeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=mapModeSchema.js.map