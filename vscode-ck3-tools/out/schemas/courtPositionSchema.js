...
exports.courtPositionSchemaMap = exports.courtPositionSchema = exports.COURT_POSITION_CATEGORIES = void 0;
exports.getCourtPositionFieldNames = getCourtPositionFieldNames;
exports.getCourtPositionFieldDocumentation = getCourtPositionFieldDocumentation;
exports.COURT_POSITION_CATEGORIES = [
    'court_position_category_common',
    'court_position_category_special',
    'court_position_category_religious',
];
exports.courtPositionSchema = [
    // Basic Properties
    {
        name: 'skill',
        type: 'enum',
    ...
    },
    {
        ...
        values: [...exports.COURT_POSITION_CATEGORIES],
...
exports.courtPositionSchemaMap = new Map(exports.courtPositionSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getCourtPositionFieldNames() {
    return exports.courtPositionSchema.map((field) => field.name);
}
// Get documentation for a field
function getCourtPositionFieldDocumentation(fieldName) {
    const field = exports.courtPositionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=courtPositionSchema.js.map