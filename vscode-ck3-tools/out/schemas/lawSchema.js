...
exports.successionLawSchemaMap = exports.lawSchemaMap = exports.successionLawSchema = exports.lawSchema = exports.LAW_GROUPS = void 0;
exports.getLawFieldNames = getLawFieldNames;
exports.getLawFieldDocumentation = getLawFieldDocumentation;
exports.LAW_GROUPS = [
    'crown_authority',
    'succession',
    'gender',
...
exports.lawSchemaMap = new Map(exports.lawSchema.map((field) => [field.name, field]));
exports.successionLawSchemaMap = new Map(exports.successionLawSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getLawFieldNames() {
    return exports.lawSchema.map((field) => field.name);
}
// Get documentation for a field
function getLawFieldDocumentation(fieldName) {
    const field = exports.lawSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=lawSchema.js.map