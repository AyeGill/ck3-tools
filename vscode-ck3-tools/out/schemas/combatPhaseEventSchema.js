...
exports.combatPhaseEventSchemaMap = exports.combatPhaseEventSchema = void 0;
exports.getCombatPhaseEventFieldNames = getCombatPhaseEventFieldNames;
exports.getCombatPhaseEventFieldDocumentation = getCombatPhaseEventFieldDocumentation;
exports.combatPhaseEventSchema = [
    // Basic Properties
    {
        name: 'phase',
        type: 'enum',
...
exports.combatPhaseEventSchemaMap = new Map(exports.combatPhaseEventSchema.map((field) => [field.name, field]));
function getCombatPhaseEventFieldNames() {
    return exports.combatPhaseEventSchema.map((field) => field.name);
}
function getCombatPhaseEventFieldDocumentation(fieldName) {
    const field = exports.combatPhaseEventSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=combatPhaseEventSchema.js.map