...
exports.terrainTypeSchemaMap = exports.terrainTypeSchema = void 0;
exports.getTerrainTypeFieldNames = getTerrainTypeFieldNames;
exports.getTerrainTypeFieldDocumentation = getTerrainTypeFieldDocumentation;
exports.terrainTypeSchema = [
    // Basic Properties
    {
        name: 'color',
        type: 'block',
...
exports.terrainTypeSchemaMap = new Map(exports.terrainTypeSchema.map((field) => [field.name, field]));
function getTerrainTypeFieldNames() {
    return exports.terrainTypeSchema.map((field) => field.name);
}
function getTerrainTypeFieldDocumentation(fieldName) {
    const field = exports.terrainTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=terrainTypeSchema.js.map