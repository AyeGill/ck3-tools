...
exports.travelerTypeSchemaMap = exports.travelerTypeSchema = void 0;
exports.getTravelerTypeFieldNames = getTravelerTypeFieldNames;
exports.getTravelerTypeFieldDocumentation = getTravelerTypeFieldDocumentation;
exports.travelerTypeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.travelerTypeSchemaMap = new Map(exports.travelerTypeSchema.map((field) => [field.name, field]));
function getTravelerTypeFieldNames() {
    return exports.travelerTypeSchema.map((field) => field.name);
}
function getTravelerTypeFieldDocumentation(fieldName) {
    const field = exports.travelerTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=travelerTypeSchema.js.map