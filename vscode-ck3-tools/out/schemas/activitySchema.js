...
exports.activitySchemaMap = exports.activitySchema = exports.ACTIVITY_TYPES = void 0;
exports.getActivityFieldNames = getActivityFieldNames;
exports.getActivityFieldDocumentation = getActivityFieldDocumentation;
...
exports.activitySchemaMap = new Map(exports.activitySchema.map((field) => [field.name, field]));
function getActivityFieldNames() {
    return exports.activitySchema.map((field) => field.name);
}
function getActivityFieldDocumentation(fieldName) {
    const field = exports.activitySchemaMap.get(fieldName);
    if (!field)
        return undefined;
