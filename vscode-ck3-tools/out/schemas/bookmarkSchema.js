...
exports.bookmarkCharacterSchemaMap = exports.bookmarkSchemaMap = exports.bookmarkCharacterSchema = exports.bookmarkSchema = void 0;
exports.getBookmarkFieldNames = getBookmarkFieldNames;
exports.getBookmarkFieldDocumentation = getBookmarkFieldDocumentation;
...
exports.bookmarkCharacterSchema = [
    {
        name: 'name',
        type: 'string',
...
exports.bookmarkSchemaMap = new Map(exports.bookmarkSchema.map((field) => [field.name, field]));
exports.bookmarkCharacterSchemaMap = new Map(exports.bookmarkCharacterSchema.map((field) => [field.name, field]));
function getBookmarkFieldNames() {
    return exports.bookmarkSchema.map((field) => field.name);
}
function getBookmarkFieldDocumentation(fieldName) {
    const field = exports.bookmarkSchemaMap.get(fieldName);
    if (!field)
        return undefined;
