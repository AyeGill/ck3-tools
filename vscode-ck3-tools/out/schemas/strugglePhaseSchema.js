...
exports.strugglePhaseSchemaMap = exports.strugglePhaseSchema = void 0;
exports.getStrugglePhaseFieldNames = getStrugglePhaseFieldNames;
exports.getStrugglePhaseFieldDocumentation = getStrugglePhaseFieldDocumentation;
exports.strugglePhaseSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.strugglePhaseSchemaMap = new Map(exports.strugglePhaseSchema.map((field) => [field.name, field]));
function getStrugglePhaseFieldNames() {
    return exports.strugglePhaseSchema.map((field) => field.name);
}
function getStrugglePhaseFieldDocumentation(fieldName) {
    const field = exports.strugglePhaseSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=strugglePhaseSchema.js.map