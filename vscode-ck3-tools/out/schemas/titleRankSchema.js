...
exports.titleRankSchemaMap = exports.titleRankSchema = void 0;
exports.getTitleRankFieldNames = getTitleRankFieldNames;
exports.getTitleRankFieldDocumentation = getTitleRankFieldDocumentation;
exports.titleRankSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.titleRankSchemaMap = new Map(exports.titleRankSchema.map((field) => [field.name, field]));
function getTitleRankFieldNames() {
    return exports.titleRankSchema.map((field) => field.name);
}
function getTitleRankFieldDocumentation(fieldName) {
    const field = exports.titleRankSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=titleRankSchema.js.map