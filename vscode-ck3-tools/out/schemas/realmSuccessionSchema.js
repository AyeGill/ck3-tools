...
exports.realmSuccessionSchemaMap = exports.realmSuccessionSchema = void 0;
exports.getRealmSuccessionFieldNames = getRealmSuccessionFieldNames;
exports.getRealmSuccessionFieldDocumentation = getRealmSuccessionFieldDocumentation;
exports.realmSuccessionSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.realmSuccessionSchemaMap = new Map(exports.realmSuccessionSchema.map((field) => [field.name, field]));
function getRealmSuccessionFieldNames() {
    return exports.realmSuccessionSchema.map((field) => field.name);
}
function getRealmSuccessionFieldDocumentation(fieldName) {
    const field = exports.realmSuccessionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=realmSuccessionSchema.js.map