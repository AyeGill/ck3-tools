...
exports.titleFlagSchemaMap = exports.titleFlagSchema = void 0;
exports.getTitleFlagFieldNames = getTitleFlagFieldNames;
exports.getTitleFlagFieldDocumentation = getTitleFlagFieldDocumentation;
exports.titleFlagSchema = [
    // Basic Properties
    {
        name: 'flag',
        type: 'string',
...
exports.titleFlagSchemaMap = new Map(exports.titleFlagSchema.map((field) => [field.name, field]));
function getTitleFlagFieldNames() {
    return exports.titleFlagSchema.map((field) => field.name);
}
function getTitleFlagFieldDocumentation(fieldName) {
    const field = exports.titleFlagSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=titleFlagSchema.js.map