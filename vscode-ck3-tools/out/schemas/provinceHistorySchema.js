...
exports.provinceHistorySchemaMap = exports.provinceHistorySchema = void 0;
exports.getProvinceHistoryFieldNames = getProvinceHistoryFieldNames;
exports.getProvinceHistoryFieldDocumentation = getProvinceHistoryFieldDocumentation;
exports.provinceHistorySchema = [
...
exports.provinceHistorySchemaMap = new Map(exports.provinceHistorySchema.map((field) => [field.name, field]));
function getProvinceHistoryFieldNames() {
    return exports.provinceHistorySchema.map((field) => field.name);
}
function getProvinceHistoryFieldDocumentation(fieldName) {
    const field = exports.provinceHistorySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=provinceHistorySchema.js.map