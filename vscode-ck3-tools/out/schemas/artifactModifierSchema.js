...
exports.artifactModifierSchemaMap = exports.artifactModifierSchema = void 0;
exports.getArtifactModifierFieldNames = getArtifactModifierFieldNames;
exports.getArtifactModifierFieldDocumentation = getArtifactModifierFieldDocumentation;
exports.artifactModifierSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.artifactModifierSchemaMap = new Map(exports.artifactModifierSchema.map((field) => [field.name, field]));
function getArtifactModifierFieldNames() {
    return exports.artifactModifierSchema.map((field) => field.name);
}
function getArtifactModifierFieldDocumentation(fieldName) {
    const field = exports.artifactModifierSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=artifactModifierSchema.js.map