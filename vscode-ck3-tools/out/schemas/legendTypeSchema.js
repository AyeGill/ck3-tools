...
exports.legendTypeSchemaMap = exports.legendTypeSchema = void 0;
exports.getLegendTypeFieldNames = getLegendTypeFieldNames;
exports.getLegendTypeFieldDocumentation = getLegendTypeFieldDocumentation;
exports.legendTypeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.legendTypeSchemaMap = new Map(exports.legendTypeSchema.map((field) => [field.name, field]));
function getLegendTypeFieldNames() {
    return exports.legendTypeSchema.map((field) => field.name);
}
function getLegendTypeFieldDocumentation(fieldName) {
    const field = exports.legendTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=legendTypeSchema.js.map