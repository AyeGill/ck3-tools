...
exports.councilTaskSchemaMap = exports.councilTaskSchema = exports.COUNCIL_POSITIONS = void 0;
exports.getCouncilTaskFieldNames = getCouncilTaskFieldNames;
exports.getCouncilTaskFieldDocumentation = getCouncilTaskFieldDocumentation;
exports.COUNCIL_POSITIONS = [
...
exports.councilTaskSchema = [
    // Basic Properties
    {
        name: 'position',
        type: 'enum',
        description: 'The council position that performs this task.',
        values: [...exports.COUNCIL_POSITIONS],
        required: true,
...
exports.councilTaskSchemaMap = new Map(exports.councilTaskSchema.map((field) => [field.name, field]));
function getCouncilTaskFieldNames() {
    return exports.councilTaskSchema.map((field) => field.name);
}
function getCouncilTaskFieldDocumentation(fieldName) {
    const field = exports.councilTaskSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=councilTaskSchema.js.map