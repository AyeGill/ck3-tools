...
exports.nameListSchemaMap = exports.nameListSchema = void 0;
exports.getNameListFieldNames = getNameListFieldNames;
exports.getNameListFieldDocumentation = getNameListFieldDocumentation;
exports.nameListSchema = [
    // Male Names
    {
        name: 'male_names',
        type: 'list',
...
exports.nameListSchemaMap = new Map(exports.nameListSchema.map((field) => [field.name, field]));
function getNameListFieldNames() {
    return exports.nameListSchema.map((field) => field.name);
}
function getNameListFieldDocumentation(fieldName) {
    const field = exports.nameListSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=nameListSchema.js.map