...
exports.vassalObligationSchemaMap = exports.vassalContractSchemaMap = exports.vassalObligationSchema = exports.vassalContractSchema = void 0;
exports.getVassalContractFieldNames = getVassalContractFieldNames;
exports.getVassalContractFieldDocumentation = getVassalContractFieldDocumentation;
exports.vassalContractSchema = [
    // Basic Properties
    {
...
exports.vassalObligationSchema = [
    {
        name: 'level',
        type: 'block',
...
exports.vassalContractSchemaMap = new Map(exports.vassalContractSchema.map((field) => [field.name, field]));
exports.vassalObligationSchemaMap = new Map(exports.vassalObligationSchema.map((field) => [field.name, field]));
function getVassalContractFieldNames() {
    return exports.vassalContractSchema.map((field) => field.name);
}
function getVassalContractFieldDocumentation(fieldName) {
    const field = exports.vassalContractSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=vassalContractSchema.js.map