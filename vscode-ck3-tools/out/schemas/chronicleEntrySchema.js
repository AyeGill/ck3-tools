...
exports.chronicleEntrySchemaMap = exports.chronicleEntrySchema = void 0;
exports.getChronicleEntryFieldNames = getChronicleEntryFieldNames;
exports.getChronicleEntryFieldDocumentation = getChronicleEntryFieldDocumentation;
exports.chronicleEntrySchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.chronicleEntrySchemaMap = new Map(exports.chronicleEntrySchema.map((field) => [field.name, field]));
function getChronicleEntryFieldNames() {
    return exports.chronicleEntrySchema.map((field) => field.name);
}
function getChronicleEntryFieldDocumentation(fieldName) {
    const field = exports.chronicleEntrySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=chronicleEntrySchema.js.map