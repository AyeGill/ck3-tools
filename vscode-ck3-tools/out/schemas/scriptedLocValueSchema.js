...
exports.scriptedLocValueSchemaMap = exports.scriptedLocValueSchema = void 0;
exports.getScriptedLocValueFieldNames = getScriptedLocValueFieldNames;
exports.getScriptedLocValueFieldDocumentation = getScriptedLocValueFieldDocumentation;
exports.scriptedLocValueSchema = [
    // Basic Properties
    {
        name: 'type',
        type: 'enum',
...
exports.scriptedLocValueSchemaMap = new Map(exports.scriptedLocValueSchema.map((field) => [field.name, field]));
function getScriptedLocValueFieldNames() {
    return exports.scriptedLocValueSchema.map((field) => field.name);
}
function getScriptedLocValueFieldDocumentation(fieldName) {
    const field = exports.scriptedLocValueSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=scriptedLocValueSchema.js.map