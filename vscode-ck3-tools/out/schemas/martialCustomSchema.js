...
exports.martialCustomSchemaMap = exports.martialCustomSchema = void 0;
exports.getMartialCustomFieldNames = getMartialCustomFieldNames;
exports.getMartialCustomFieldDocumentation = getMartialCustomFieldDocumentation;
exports.martialCustomSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.martialCustomSchemaMap = new Map(exports.martialCustomSchema.map((field) => [field.name, field]));
function getMartialCustomFieldNames() {
    return exports.martialCustomSchema.map((field) => field.name);
}
function getMartialCustomFieldDocumentation(fieldName) {
    const field = exports.martialCustomSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=martialCustomSchema.js.map