...
exports.tutorialSchemaMap = exports.tutorialSchema = void 0;
exports.getTutorialFieldNames = getTutorialFieldNames;
exports.getTutorialFieldDocumentation = getTutorialFieldDocumentation;
...
exports.tutorialSchemaMap = new Map(exports.tutorialSchema.map((field) => [field.name, field]));
function getTutorialFieldNames() {
    return exports.tutorialSchema.map((field) => field.name);
}
function getTutorialFieldDocumentation(fieldName) {
    const field = exports.tutorialSchemaMap.get(fieldName);
    if (!field)
        return undefined;
