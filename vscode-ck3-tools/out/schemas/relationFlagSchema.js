...
exports.relationFlagSchemaMap = exports.relationFlagSchema = void 0;
exports.getRelationFlagFieldNames = getRelationFlagFieldNames;
exports.getRelationFlagFieldDocumentation = getRelationFlagFieldDocumentation;
exports.relationFlagSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.relationFlagSchemaMap = new Map(exports.relationFlagSchema.map((field) => [field.name, field]));
function getRelationFlagFieldNames() {
    return exports.relationFlagSchema.map((field) => field.name);
}
function getRelationFlagFieldDocumentation(fieldName) {
    const field = exports.relationFlagSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=relationFlagSchema.js.map