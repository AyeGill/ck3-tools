...
exports.portraitCameraSchemaMap = exports.portraitCameraSchema = void 0;
exports.getPortraitCameraFieldNames = getPortraitCameraFieldNames;
exports.getPortraitCameraFieldDocumentation = getPortraitCameraFieldDocumentation;
exports.portraitCameraSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.portraitCameraSchemaMap = new Map(exports.portraitCameraSchema.map((field) => [field.name, field]));
function getPortraitCameraFieldNames() {
    return exports.portraitCameraSchema.map((field) => field.name);
}
function getPortraitCameraFieldDocumentation(fieldName) {
    const field = exports.portraitCameraSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=portraitCameraSchema.js.map