...
exports.titleHistorySchemaMap = exports.titleHistorySchema = void 0;
exports.getTitleHistoryFieldNames = getTitleHistoryFieldNames;
exports.getTitleHistoryFieldDocumentation = getTitleHistoryFieldDocumentation;
exports.titleHistorySchema = [
    // Holder
    {
        name: 'holder',
        type: 'integer',
...
exports.titleHistorySchemaMap = new Map(exports.titleHistorySchema.map((field) => [field.name, field]));
function getTitleHistoryFieldNames() {
    return exports.titleHistorySchema.map((field) => field.name);
}
function getTitleHistoryFieldDocumentation(fieldName) {
    const field = exports.titleHistorySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=titleHistorySchema.js.map