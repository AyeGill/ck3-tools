...
exports.characterMemorySchemaMap = exports.characterMemorySchema = void 0;
exports.getCharacterMemoryFieldNames = getCharacterMemoryFieldNames;
exports.getCharacterMemoryFieldDocumentation = getCharacterMemoryFieldDocumentation;
exports.characterMemorySchema = [
    // Basic Properties
    {
        name: 'category',
        type: 'string',
...
exports.characterMemorySchemaMap = new Map(exports.characterMemorySchema.map((field) => [field.name, field]));
function getCharacterMemoryFieldNames() {
    return exports.characterMemorySchema.map((field) => field.name);
}
function getCharacterMemoryFieldDocumentation(fieldName) {
    const field = exports.characterMemorySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=characterMemorySchema.js.map