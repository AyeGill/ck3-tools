...
exports.aiPersonalitySchemaMap = exports.aiPersonalitySchema = void 0;
exports.getAiPersonalityFieldNames = getAiPersonalityFieldNames;
exports.getAiPersonalityFieldDocumentation = getAiPersonalityFieldDocumentation;
exports.aiPersonalitySchema = [
    // Behavior Weights
    {
        name: 'aggression',
        type: 'float',
...
exports.aiPersonalitySchemaMap = new Map(exports.aiPersonalitySchema.map((field) => [field.name, field]));
function getAiPersonalityFieldNames() {
    return exports.aiPersonalitySchema.map((field) => field.name);
}
function getAiPersonalityFieldDocumentation(fieldName) {
    const field = exports.aiPersonalitySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=aiPersonalitySchema.js.map