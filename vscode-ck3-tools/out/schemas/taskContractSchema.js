...
exports.taskContractSchemaMap = exports.taskContractSchema = void 0;
exports.getTaskContractFieldNames = getTaskContractFieldNames;
exports.getTaskContractFieldDocumentation = getTaskContractFieldDocumentation;
...
exports.taskContractSchemaMap = new Map(exports.taskContractSchema.map((field) => [field.name, field]));
function getTaskContractFieldNames() {
    return exports.taskContractSchema.map((field) => field.name);
}
function getTaskContractFieldDocumentation(fieldName) {
    const field = exports.taskContractSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=taskContractSchema.js.map