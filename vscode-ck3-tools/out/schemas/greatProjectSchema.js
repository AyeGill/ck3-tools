...
exports.greatProjectSchemaMap = exports.greatProjectSchema = void 0;
exports.getGreatProjectFieldNames = getGreatProjectFieldNames;
exports.getGreatProjectFieldDocumentation = getGreatProjectFieldDocumentation;
exports.greatProjectSchema = [
    // Basic Properties
    {
        name: 'type',
        type: 'enum',
...
exports.greatProjectSchemaMap = new Map(exports.greatProjectSchema.map((field) => [field.name, field]));
function getGreatProjectFieldNames() {
    return exports.greatProjectSchema.map((field) => field.name);
}
function getGreatProjectFieldDocumentation(fieldName) {
    const field = exports.greatProjectSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=greatProjectSchema.js.map