...
exports.successionVotingSchemaMap = exports.successionVotingSchema = void 0;
exports.getSuccessionVotingFieldNames = getSuccessionVotingFieldNames;
exports.getSuccessionVotingFieldDocumentation = getSuccessionVotingFieldDocumentation;
exports.successionVotingSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.successionVotingSchemaMap = new Map(exports.successionVotingSchema.map((field) => [field.name, field]));
function getSuccessionVotingFieldNames() {
    return exports.successionVotingSchema.map((field) => field.name);
}
function getSuccessionVotingFieldDocumentation(fieldName) {
    const field = exports.successionVotingSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=successionVotingSchema.js.map