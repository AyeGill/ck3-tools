...
exports.ethnicGroupSchemaMap = exports.ethnicGroupSchema = void 0;
exports.getEthnicGroupFieldNames = getEthnicGroupFieldNames;
exports.getEthnicGroupFieldDocumentation = getEthnicGroupFieldDocumentation;
exports.ethnicGroupSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.ethnicGroupSchemaMap = new Map(exports.ethnicGroupSchema.map((field) => [field.name, field]));
function getEthnicGroupFieldNames() {
    return exports.ethnicGroupSchema.map((field) => field.name);
}
function getEthnicGroupFieldDocumentation(fieldName) {
    const field = exports.ethnicGroupSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=ethnicGroupSchema.js.map