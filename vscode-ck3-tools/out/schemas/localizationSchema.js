...
exports.localizationSchemaMap = exports.localizationSchema = void 0;
exports.getLocalizationFieldNames = getLocalizationFieldNames;
exports.getLocalizationFieldDocumentation = getLocalizationFieldDocumentation;
exports.localizationSchema = [
    // Basic Properties
    {
        name: 'l_english',
        type: 'block',
...
exports.localizationSchemaMap = new Map(exports.localizationSchema.map((field) => [field.name, field]));
function getLocalizationFieldNames() {
    return exports.localizationSchema.map((field) => field.name);
}
function getLocalizationFieldDocumentation(fieldName) {
    const field = exports.localizationSchemaMap.get(fieldName);
    if (!field)
        return undefined;
