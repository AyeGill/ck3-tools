...
exports.poolSelectorSchemaMap = exports.poolSelectorSchema = void 0;
exports.getPoolSelectorFieldNames = getPoolSelectorFieldNames;
exports.getPoolSelectorFieldDocumentation = getPoolSelectorFieldDocumentation;
exports.poolSelectorSchema = [
    // Basic Properties
    {
        name: 'pool',
        type: 'enum',
...
exports.poolSelectorSchemaMap = new Map(exports.poolSelectorSchema.map((field) => [field.name, field]));
function getPoolSelectorFieldNames() {
    return exports.poolSelectorSchema.map((field) => field.name);
}
function getPoolSelectorFieldDocumentation(fieldName) {
    const field = exports.poolSelectorSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=poolSelectorSchema.js.map