...
exports.aiWarStanceSchemaMap = exports.aiWarStanceSchema = void 0;
exports.getAiWarStanceFieldNames = getAiWarStanceFieldNames;
exports.getAiWarStanceFieldDocumentation = getAiWarStanceFieldDocumentation;
exports.aiWarStanceSchema = [
    // Basic Properties
    {
        name: 'stance_type',
        type: 'enum',
...
exports.aiWarStanceSchemaMap = new Map(exports.aiWarStanceSchema.map((field) => [field.name, field]));
function getAiWarStanceFieldNames() {
    return exports.aiWarStanceSchema.map((field) => field.name);
}
function getAiWarStanceFieldDocumentation(fieldName) {
    const field = exports.aiWarStanceSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=aiWarStanceSchema.js.map