...
exports.accessorySchemaMap = exports.accessorySchema = void 0;
exports.getAccessoryFieldNames = getAccessoryFieldNames;
exports.getAccessoryFieldDocumentation = getAccessoryFieldDocumentation;
...
exports.accessorySchemaMap = new Map(exports.accessorySchema.map((field) => [field.name, field]));
function getAccessoryFieldNames() {
    return exports.accessorySchema.map((field) => field.name);
}
function getAccessoryFieldDocumentation(fieldName) {
    const field = exports.accessorySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=accessorySchema.js.map