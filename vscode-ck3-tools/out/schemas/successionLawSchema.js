...
exports.successionLawSchemaMap = exports.successionLawSchema = void 0;
exports.getSuccessionLawFieldNames = getSuccessionLawFieldNames;
exports.getSuccessionLawFieldDocumentation = getSuccessionLawFieldDocumentation;
...
function getSuccessionLawFieldNames() {
    return exports.successionLawSchema.map((field) => field.name);
}
function getSuccessionLawFieldDocumentation(fieldName) {
    const field = exports.successionLawSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=successionLawSchema.js.map