...
exports.courtAmenitySchemaMap = exports.courtAmenitySchema = exports.AMENITY_TYPES = void 0;
exports.getCourtAmenityFieldNames = getCourtAmenityFieldNames;
exports.getCourtAmenityFieldDocumentation = getCourtAmenityFieldDocumentation;
...
exports.courtAmenitySchema = [
    // Basic Properties
    {
        name: 'type',
        type: 'enum',
        description: 'Type of court amenity.',
        values: [...exports.AMENITY_TYPES],
...
exports.courtAmenitySchemaMap = new Map(exports.courtAmenitySchema.map((field) => [field.name, field]));
function getCourtAmenityFieldNames() {
    return exports.courtAmenitySchema.map((field) => field.name);
}
function getCourtAmenityFieldDocumentation(fieldName) {
    const field = exports.courtAmenitySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=courtAmenitySchema.js.map