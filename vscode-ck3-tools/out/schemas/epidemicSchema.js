...
exports.epidemicSchemaMap = exports.epidemicSchema = void 0;
exports.getEpidemicFieldNames = getEpidemicFieldNames;
exports.getEpidemicFieldDocumentation = getEpidemicFieldDocumentation;
exports.epidemicSchema = [
    // Basic Properties
    {
        name: 'trait',
        type: 'string',
...
exports.epidemicSchemaMap = new Map(exports.epidemicSchema.map((field) => [field.name, field]));
function getEpidemicFieldNames() {
    return exports.epidemicSchema.map((field) => field.name);
}
function getEpidemicFieldDocumentation(fieldName) {
    const field = exports.epidemicSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=epidemicSchema.js.map