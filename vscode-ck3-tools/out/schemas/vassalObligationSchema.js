...
exports.vassalObligationSchemaMap = exports.vassalObligationSchema = void 0;
exports.getVassalObligationFieldNames = getVassalObligationFieldNames;
exports.getVassalObligationFieldDocumentation = getVassalObligationFieldDocumentation;
...
function getVassalObligationFieldNames() {
    return exports.vassalObligationSchema.map((field) => field.name);
}
function getVassalObligationFieldDocumentation(fieldName) {
    const field = exports.vassalObligationSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=vassalObligationSchema.js.map