...
exports.artifactRaritySchemaMap = exports.artifactRaritySchema = void 0;
exports.getArtifactRarityFieldNames = getArtifactRarityFieldNames;
exports.getArtifactRarityFieldDocumentation = getArtifactRarityFieldDocumentation;
exports.artifactRaritySchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.artifactRaritySchemaMap = new Map(exports.artifactRaritySchema.map((field) => [field.name, field]));
function getArtifactRarityFieldNames() {
    return exports.artifactRaritySchema.map((field) => field.name);
}
function getArtifactRarityFieldDocumentation(fieldName) {
    const field = exports.artifactRaritySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=artifactRaritySchema.js.map