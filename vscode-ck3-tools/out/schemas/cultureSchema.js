...
exports.traditionSchemaMap = exports.cultureSchemaMap = exports.traditionSchema = exports.cultureSchema = exports.NAME_LISTS = exports.MARTIAL_CUSTOMS = exports.CULTURE_ERAS = void 0;
exports.getCultureFieldNames = getCultureFieldNames;
exports.getTraditionFieldNames = getTraditionFieldNames;
exports.getCultureFieldDocumentation = getCultureFieldDocumentation;
exports.CULTURE_ERAS = [
    'culture_era_tribal',
    'culture_era_early_medieval',
    'culture_era_high_medieval',
    'culture_era_late_medieval',
];
exports.MARTIAL_CUSTOMS = [
...
exports.cultureSchema = [
    ...
    },
    {
        ...
        values: [...exports.MARTIAL_CUSTOMS],
...
exports.cultureSchemaMap = new Map(exports.cultureSchema.map((field) => [field.name, field]));
exports.traditionSchemaMap = new Map(exports.traditionSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getCultureFieldNames() {
    return exports.cultureSchema.map((field) => field.name);
}
function getTraditionFieldNames() {
    return exports.traditionSchema.map((field) => field.name);
}
// Get documentation for a field
function getCultureFieldDocumentation(fieldName) {
    const field = exports.cultureSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=cultureSchema.js.map