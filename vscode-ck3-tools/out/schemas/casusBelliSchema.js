...
exports.casusBelliSchemaMap = exports.casusBelliSchema = exports.CB_GROUPS = void 0;
exports.getCasusBelliFieldNames = getCasusBelliFieldNames;
exports.getCasusBelliFieldDocumentation = getCasusBelliFieldDocumentation;
exports.CB_GROUPS = [
    'conquest',
    'claim',
    'de_jure',
...
exports.casusBelliSchema = [
    // Basic Properties
    {
        name: 'group',
        type: 'enum',
        description: 'The category this CB belongs to.',
        values: [...exports.CB_GROUPS],
...
exports.casusBelliSchemaMap = new Map(exports.casusBelliSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getCasusBelliFieldNames() {
    return exports.casusBelliSchema.map((field) => field.name);
}
// Get documentation for a field
function getCasusBelliFieldDocumentation(fieldName) {
    const field = exports.casusBelliSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=casusBelliSchema.js.map