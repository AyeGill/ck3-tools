...
exports.commanderTraitSchemaMap = exports.commanderTraitSchema = void 0;
exports.getCommanderTraitFieldNames = getCommanderTraitFieldNames;
exports.getCommanderTraitFieldDocumentation = getCommanderTraitFieldDocumentation;
exports.commanderTraitSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.commanderTraitSchemaMap = new Map(exports.commanderTraitSchema.map((field) => [field.name, field]));
function getCommanderTraitFieldNames() {
    return exports.commanderTraitSchema.map((field) => field.name);
}
function getCommanderTraitFieldDocumentation(fieldName) {
    const field = exports.commanderTraitSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=commanderTraitSchema.js.map