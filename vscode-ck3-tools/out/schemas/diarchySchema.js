...
exports.diarchySchemaMap = exports.diarchySchema = void 0;
exports.getDiarchyFieldNames = getDiarchyFieldNames;
exports.getDiarchyFieldDocumentation = getDiarchyFieldDocumentation;
exports.diarchySchema = [
    // Basic Properties
    {
        name: 'diarch_type',
        type: 'enum',
...
exports.diarchySchemaMap = new Map(exports.diarchySchema.map((field) => [field.name, field]));
function getDiarchyFieldNames() {
    return exports.diarchySchema.map((field) => field.name);
}
function getDiarchyFieldDocumentation(fieldName) {
    const field = exports.diarchySchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=diarchySchema.js.map