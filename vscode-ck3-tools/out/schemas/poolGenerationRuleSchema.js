...
exports.poolGenerationRuleSchemaMap = exports.poolGenerationRuleSchema = void 0;
exports.getPoolGenerationRuleFieldNames = getPoolGenerationRuleFieldNames;
exports.getPoolGenerationRuleFieldDocumentation = getPoolGenerationRuleFieldDocumentation;
exports.poolGenerationRuleSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.poolGenerationRuleSchemaMap = new Map(exports.poolGenerationRuleSchema.map((field) => [field.name, field]));
function getPoolGenerationRuleFieldNames() {
    return exports.poolGenerationRuleSchema.map((field) => field.name);
}
function getPoolGenerationRuleFieldDocumentation(fieldName) {
    const field = exports.poolGenerationRuleSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=poolGenerationRuleSchema.js.map