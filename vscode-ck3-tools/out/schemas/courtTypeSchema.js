...
exports.courtTypeSchemaMap = exports.courtTypeSchema = void 0;
exports.getCourtTypeFieldNames = getCourtTypeFieldNames;
exports.getCourtTypeFieldDocumentation = getCourtTypeFieldDocumentation;
exports.courtTypeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.courtTypeSchemaMap = new Map(exports.courtTypeSchema.map((field) => [field.name, field]));
function getCourtTypeFieldNames() {
    return exports.courtTypeSchema.map((field) => field.name);
}
function getCourtTypeFieldDocumentation(fieldName) {
    const field = exports.courtTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=courtTypeSchema.js.map