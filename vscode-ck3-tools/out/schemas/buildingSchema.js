...
exports.buildingSchemaMap = exports.buildingSchema = exports.BUILDING_TYPES = void 0;
exports.getBuildingFieldNames = getBuildingFieldNames;
exports.getBuildingFieldDocumentation = getBuildingFieldDocumentation;
...
exports.buildingSchemaMap = new Map(exports.buildingSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getBuildingFieldNames() {
    return exports.buildingSchema.map((field) => field.name);
}
// Get documentation for a field
function getBuildingFieldDocumentation(fieldName) {
    const field = exports.buildingSchemaMap.get(fieldName);
    if (!field)
        return undefined;
