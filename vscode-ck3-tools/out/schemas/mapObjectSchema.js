...
exports.mapObjectSchemaMap = exports.mapObjectSchema = void 0;
exports.getMapObjectFieldNames = getMapObjectFieldNames;
exports.getMapObjectFieldDocumentation = getMapObjectFieldDocumentation;
exports.mapObjectSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.mapObjectSchemaMap = new Map(exports.mapObjectSchema.map((field) => [field.name, field]));
function getMapObjectFieldNames() {
    return exports.mapObjectSchema.map((field) => field.name);
}
function getMapObjectFieldDocumentation(fieldName) {
    const field = exports.mapObjectSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=mapObjectSchema.js.map