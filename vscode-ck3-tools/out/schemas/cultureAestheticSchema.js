...
exports.cultureAestheticSchemaMap = exports.cultureAestheticSchema = void 0;
exports.getCultureAestheticFieldNames = getCultureAestheticFieldNames;
exports.getCultureAestheticFieldDocumentation = getCultureAestheticFieldDocumentation;
exports.cultureAestheticSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.cultureAestheticSchemaMap = new Map(exports.cultureAestheticSchema.map((field) => [field.name, field]));
function getCultureAestheticFieldNames() {
    return exports.cultureAestheticSchema.map((field) => field.name);
}
function getCultureAestheticFieldDocumentation(fieldName) {
    const field = exports.cultureAestheticSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=cultureAestheticSchema.js.map