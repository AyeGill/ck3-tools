...
exports.terrainModifierSchemaMap = exports.terrainModifierSchema = void 0;
exports.getTerrainModifierFieldNames = getTerrainModifierFieldNames;
exports.getTerrainModifierFieldDocumentation = getTerrainModifierFieldDocumentation;
exports.terrainModifierSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.terrainModifierSchemaMap = new Map(exports.terrainModifierSchema.map((field) => [field.name, field]));
function getTerrainModifierFieldNames() {
    return exports.terrainModifierSchema.map((field) => field.name);
}
function getTerrainModifierFieldDocumentation(fieldName) {
    const field = exports.terrainModifierSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=terrainModifierSchema.js.map