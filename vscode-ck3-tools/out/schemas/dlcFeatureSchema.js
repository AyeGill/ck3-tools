...
exports.dlcFeatureSchemaMap = exports.dlcFeatureSchema = void 0;
exports.getDlcFeatureFieldNames = getDlcFeatureFieldNames;
exports.getDlcFeatureFieldDocumentation = getDlcFeatureFieldDocumentation;
exports.dlcFeatureSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.dlcFeatureSchemaMap = new Map(exports.dlcFeatureSchema.map((field) => [field.name, field]));
function getDlcFeatureFieldNames() {
    return exports.dlcFeatureSchema.map((field) => field.name);
}
function getDlcFeatureFieldDocumentation(fieldName) {
    const field = exports.dlcFeatureSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=dlcFeatureSchema.js.map