...
exports.specialBuildingSchemaMap = exports.specialBuildingSchema = void 0;
exports.getSpecialBuildingFieldNames = getSpecialBuildingFieldNames;
exports.getSpecialBuildingFieldDocumentation = getSpecialBuildingFieldDocumentation;
exports.specialBuildingSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.specialBuildingSchemaMap = new Map(exports.specialBuildingSchema.map((field) => [field.name, field]));
function getSpecialBuildingFieldNames() {
    return exports.specialBuildingSchema.map((field) => field.name);
}
function getSpecialBuildingFieldDocumentation(fieldName) {
    const field = exports.specialBuildingSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=specialBuildingSchema.js.map