...
exports.cultureNameListSchemaMap = exports.cultureNameListSchema = void 0;
exports.getCultureNameListFieldNames = getCultureNameListFieldNames;
exports.getCultureNameListFieldDocumentation = getCultureNameListFieldDocumentation;
exports.cultureNameListSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.cultureNameListSchemaMap = new Map(exports.cultureNameListSchema.map((field) => [field.name, field]));
function getCultureNameListFieldNames() {
    return exports.cultureNameListSchema.map((field) => field.name);
}
function getCultureNameListFieldDocumentation(fieldName) {
    const field = exports.cultureNameListSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=cultureNameListSchema.js.map