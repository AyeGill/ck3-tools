...
exports.titleColorSchemaMap = exports.titleColorSchema = void 0;
exports.getTitleColorFieldNames = getTitleColorFieldNames;
exports.getTitleColorFieldDocumentation = getTitleColorFieldDocumentation;
exports.titleColorSchema = [
    // Basic Properties
    {
        name: 'color',
        type: 'block',
...
exports.titleColorSchemaMap = new Map(exports.titleColorSchema.map((field) => [field.name, field]));
function getTitleColorFieldNames() {
    return exports.titleColorSchema.map((field) => field.name);
}
function getTitleColorFieldDocumentation(fieldName) {
    const field = exports.titleColorSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=titleColorSchema.js.map