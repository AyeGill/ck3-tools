...
exports.SEX_VALUES = ['male', 'female', 'all'];
exports.INHERITANCE_BLOCKER_VALUES = ['all', 'dynasty', 'none'];
exports.traitSchema = [
    // Basic Properties
    {
        name: 'category',
        ...
        values: [...exports.TRAIT_CATEGORIES],
        required: true,
    ...
    },
    {
        ...
        values: [...exports.INHERITANCE_BLOCKER_VALUES],
        default: 'none',
 ...
 */
exports.descriptionBlockSchema = [
    {
        name: 'first_valid',
        type: 'block',
...
exports.descriptionBlockSchemaMap = new Map(exports.descriptionBlockSchema.map((field) => [field.name, field]));
exports.triggeredDescSchemaMap = new Map(exports.triggeredDescSchema.map((field) => [field.name, field]));
 ...
 */
function getSchemaForContext(blockPath) {
    ...
    switch (currentBlock) {
        ...
        case 'icon':
            ...
            return exports.descriptionBlockSchema;
        case 'triggered_desc':
            return exports.triggeredDescSchema;
        case 'first_valid':
        case 'random_valid':
            return exports.validDescListSchema;
        case 'trigger':
        case 'potential':
            return exports.triggerBlockSchema;
        case 'NOT':
        case 'AND':
        case 'OR':
        case 'NAND':
 ...
 */
function getSchemaMapForContext(blockPath) {
...
function getTraitFieldNames() {
    return exports.traitSchema.map((field) => field.name);
}
// Get completions for a specific field's values (if enum)
function getFieldValues(fieldName) {
    const field = exports.traitSchemaMap.get(fieldName);
...
function getFieldDocumentation(fieldName) {
    const field = exports.traitSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=traitSchema.js.map