...
exports.triggeredTextSchemaMap = exports.triggeredTextSchema = void 0;
exports.getTriggeredTextFieldNames = getTriggeredTextFieldNames;
exports.getTriggeredTextFieldDocumentation = getTriggeredTextFieldDocumentation;
exports.triggeredTextSchema = [
    // Basic Properties
    {
        name: 'key',
        type: 'string',
...
exports.triggeredTextSchemaMap = new Map(exports.triggeredTextSchema.map((field) => [field.name, field]));
function getTriggeredTextFieldNames() {
    return exports.triggeredTextSchema.map((field) => field.name);
}
function getTriggeredTextFieldDocumentation(fieldName) {
    const field = exports.triggeredTextSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=triggeredTextSchema.js.map