...
exports.doctrineGroupSchemaMap = exports.doctrineSchemaMap = exports.doctrineGroupSchema = exports.doctrineSchema = exports.DOCTRINE_GROUPS = void 0;
exports.getDoctrineFieldNames = getDoctrineFieldNames;
exports.getDoctrineFieldDocumentation = getDoctrineFieldDocumentation;
...
exports.doctrineGroupSchemaMap = new Map(exports.doctrineGroupSchema.map((field) => [field.name, field]));
function getDoctrineFieldNames() {
    return exports.doctrineSchema.map((field) => field.name);
}
function getDoctrineFieldDocumentation(fieldName) {
    const field = exports.doctrineSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=doctrineSchema.js.map