...
exports.heritageSchemaMap = exports.heritageSchema = void 0;
exports.getHeritageFieldNames = getHeritageFieldNames;
exports.getHeritageFieldDocumentation = getHeritageFieldDocumentation;
exports.heritageSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.heritageSchemaMap = new Map(exports.heritageSchema.map((field) => [field.name, field]));
function getHeritageFieldNames() {
    return exports.heritageSchema.map((field) => field.name);
}
function getHeritageFieldDocumentation(fieldName) {
    const field = exports.heritageSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=heritageSchema.js.map