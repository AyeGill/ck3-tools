...
exports.accoladeTypeSchemaMap = exports.accoladeTypeSchema = exports.ACCOLADE_CATEGORIES = void 0;
exports.getAccoladeTypeFieldNames = getAccoladeTypeFieldNames;
exports.getAccoladeTypeFieldDocumentation = getAccoladeTypeFieldDocumentation;
exports.ACCOLADE_CATEGORIES = [
    'arena',
    'commander',
    'duelist',
    'hunter',
...
exports.accoladeTypeSchema = [
    // Basic Properties
    {
        name: 'category',
        type: 'enum',
        description: 'Category of the accolade.',
        values: [...exports.ACCOLADE_CATEGORIES],
...
exports.accoladeTypeSchemaMap = new Map(exports.accoladeTypeSchema.map((field) => [field.name, field]));
function getAccoladeTypeFieldNames() {
    return exports.accoladeTypeSchema.map((field) => field.name);
}
function getAccoladeTypeFieldDocumentation(fieldName) {
    const field = exports.accoladeTypeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=accoladeTypeSchema.js.map