...
exports.modifierSchemaMap = exports.modifierSchema = exports.COMMON_MODIFIERS = exports.MODIFIER_TYPES = void 0;
exports.getModifierFieldNames = getModifierFieldNames;
exports.getModifierFieldDocumentation = getModifierFieldDocumentation;
exports.MODIFIER_TYPES = [
    'character',
    'province',
    'county',
    'title',
...
exports.modifierSchemaMap = new Map(exports.modifierSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getModifierFieldNames() {
    return exports.modifierSchema.map((field) => field.name);
}
// Get documentation for a field
function getModifierFieldDocumentation(fieldName) {
    const field = exports.modifierSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=modifierSchema.js.map