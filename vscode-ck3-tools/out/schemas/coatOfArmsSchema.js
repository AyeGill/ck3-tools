...
exports.coaTemplateSchemaMap = exports.coatOfArmsSchemaMap = exports.coaTemplateSchema = exports.coatOfArmsSchema = void 0;
exports.getCoatOfArmsFieldNames = getCoatOfArmsFieldNames;
exports.getCoatOfArmsFieldDocumentation = getCoatOfArmsFieldDocumentation;
exports.coatOfArmsSchema = [
    // Pattern
    {
        name: 'pattern',
        type: 'string',
...
exports.coatOfArmsSchemaMap = new Map(exports.coatOfArmsSchema.map((field) => [field.name, field]));
exports.coaTemplateSchemaMap = new Map(exports.coaTemplateSchema.map((field) => [field.name, field]));
function getCoatOfArmsFieldNames() {
    return exports.coatOfArmsSchema.map((field) => field.name);
}
function getCoatOfArmsFieldDocumentation(fieldName) {
    const field = exports.coatOfArmsSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=coatOfArmsSchema.js.map