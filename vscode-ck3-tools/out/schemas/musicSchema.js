...
exports.musicSchemaMap = exports.musicSchema = void 0;
exports.getMusicFieldNames = getMusicFieldNames;
exports.getMusicFieldDocumentation = getMusicFieldDocumentation;
exports.musicSchema = [
    // Basic Properties
    {
        name: 'name',
...
exports.musicSchemaMap = new Map(exports.musicSchema.map((field) => [field.name, field]));
function getMusicFieldNames() {
    return exports.musicSchema.map((field) => field.name);
}
function getMusicFieldDocumentation(fieldName) {
    const field = exports.musicSchemaMap.get(fieldName);
    if (!field)
        return undefined;
