...
exports.COMMON_ON_ACTIONS = exports.randomEventsSchemaMap = exports.randomEventsSchema = exports.onActionSchemaMap = exports.onActionSchema = void 0;
exports.getOnActionFieldNames = getOnActionFieldNames;
exports.getOnActionFieldDocumentation = getOnActionFieldDocumentation;
exports.onActionSchema = [
    // Basic Properties
    {
        name: 'trigger',
        type: 'trigger',
...
exports.onActionSchemaMap = new Map(exports.onActionSchema.map((field) => [field.name, field]));
/**
 * Schema for random_events blocks
 */
exports.randomEventsSchema = [
    {
...
exports.randomEventsSchemaMap = new Map(exports.randomEventsSchema.map((field) => [field.name, field]));
// Common on_action names for reference
exports.COMMON_ON_ACTIONS = [
    // Character lifecycle
    'on_birth_child',
    'on_birth_mother',
    'on_birth_father',
...
function getOnActionFieldNames() {
    return exports.onActionSchema.map((field) => field.name);
}
// Get documentation for a field
function getOnActionFieldDocumentation(fieldName) {
    const field = exports.onActionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=onActionSchema.js.map