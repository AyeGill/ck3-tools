...
exports.taxSlotSchemaMap = exports.taxSlotSchema = void 0;
exports.getTaxSlotFieldNames = getTaxSlotFieldNames;
exports.getTaxSlotFieldDocumentation = getTaxSlotFieldDocumentation;
exports.taxSlotSchema = [
    // Basic Properties
    {
        name: 'slot_type',
        type: 'string',
...
exports.taxSlotSchemaMap = new Map(exports.taxSlotSchema.map((field) => [field.name, field]));
function getTaxSlotFieldNames() {
    return exports.taxSlotSchema.map((field) => field.name);
}
function getTaxSlotFieldDocumentation(fieldName) {
    const field = exports.taxSlotSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=taxSlotSchema.js.map