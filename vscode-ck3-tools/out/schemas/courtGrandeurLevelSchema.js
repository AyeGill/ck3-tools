...
exports.courtGrandeurLevelSchemaMap = exports.courtGrandeurLevelSchema = void 0;
exports.getCourtGrandeurLevelFieldNames = getCourtGrandeurLevelFieldNames;
exports.getCourtGrandeurLevelFieldDocumentation = getCourtGrandeurLevelFieldDocumentation;
exports.courtGrandeurLevelSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.courtGrandeurLevelSchemaMap = new Map(exports.courtGrandeurLevelSchema.map((field) => [field.name, field]));
function getCourtGrandeurLevelFieldNames() {
    return exports.courtGrandeurLevelSchema.map((field) => field.name);
}
function getCourtGrandeurLevelFieldDocumentation(fieldName) {
    const field = exports.courtGrandeurLevelSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=courtGrandeurLevelSchema.js.map