...
exports.lifestylePerkTreeSchemaMap = exports.lifestylePerkTreeSchema = void 0;
exports.getLifestylePerkTreeFieldNames = getLifestylePerkTreeFieldNames;
exports.getLifestylePerkTreeFieldDocumentation = getLifestylePerkTreeFieldDocumentation;
exports.lifestylePerkTreeSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.lifestylePerkTreeSchemaMap = new Map(exports.lifestylePerkTreeSchema.map((field) => [field.name, field]));
function getLifestylePerkTreeFieldNames() {
    return exports.lifestylePerkTreeSchema.map((field) => field.name);
}
function getLifestylePerkTreeFieldDocumentation(fieldName) {
    const field = exports.lifestylePerkTreeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=lifestylePerkTreeSchema.js.map