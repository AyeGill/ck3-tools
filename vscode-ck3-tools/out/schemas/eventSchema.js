...
exports.portraitBlockSchemaMap = exports.portraitBlockSchema = exports.eventOptionSchemaMap = exports.eventOptionSchema = exports.eventSchemaMap = exports.eventSchema = exports.PORTRAIT_ANIMATIONS = exports.EVENT_THEMES = exports.EVENT_TYPES = void 0;
exports.getEventFieldNames = getEventFieldNames;
exports.getEventFieldDocumentation = getEventFieldDocumentation;
exports.EVENT_TYPES = [
    'character_event',
    'letter_event',
    'court_event',
...
exports.eventSchemaMap = new Map(exports.eventSchema.map((field) => [field.name, field]));
/**
 * Schema for event option blocks
 */
exports.eventOptionSchema = [
    {
        name: 'name',
        type: 'string',
...
exports.eventOptionSchemaMap = new Map(exports.eventOptionSchema.map((field) => [field.name, field]));
/**
 * Schema for portrait blocks
 */
exports.portraitBlockSchema = [
    {
        name: 'character',
        type: 'string',
    ...
    },
    {
        ...
        values: [...exports.PORTRAIT_ANIMATIONS],
        default: 'idle',
...
exports.portraitBlockSchemaMap = new Map(exports.portraitBlockSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getEventFieldNames() {
    return exports.eventSchema.map((field) => field.name);
}
// Get documentation for a field
function getEventFieldDocumentation(fieldName) {
    const field = exports.eventSchemaMap.get(fieldName);
    if (!field)
        return undefined;
