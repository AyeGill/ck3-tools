...
exports.eventThemeSchemaMap = exports.eventThemeSchema = void 0;
exports.getEventThemeFieldNames = getEventThemeFieldNames;
exports.getEventThemeFieldDocumentation = getEventThemeFieldDocumentation;
exports.eventThemeSchema = [
    // Basic Properties
    {
        name: 'icon',
        type: 'string',
...
exports.eventThemeSchemaMap = new Map(exports.eventThemeSchema.map((field) => [field.name, field]));
function getEventThemeFieldNames() {
    return exports.eventThemeSchema.map((field) => field.name);
}
function getEventThemeFieldDocumentation(fieldName) {
    const field = exports.eventThemeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=eventThemeSchema.js.map