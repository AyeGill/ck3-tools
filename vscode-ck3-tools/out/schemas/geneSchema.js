...
exports.geneSchemaMap = exports.geneSchema = void 0;
exports.getGeneFieldNames = getGeneFieldNames;
exports.getGeneFieldDocumentation = getGeneFieldDocumentation;
exports.geneSchema = [
    // Basic Properties
    {
        name: 'name',
...
exports.geneSchemaMap = new Map(exports.geneSchema.map((field) => [field.name, field]));
function getGeneFieldNames() {
    return exports.geneSchema.map((field) => field.name);
}
function getGeneFieldDocumentation(fieldName) {
    const field = exports.geneSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=geneSchema.js.map