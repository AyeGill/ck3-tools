...
exports.importantActionSchemaMap = exports.importantActionSchema = exports.IMPORTANT_ACTION_TYPES = void 0;
exports.getImportantActionFieldNames = getImportantActionFieldNames;
exports.getImportantActionFieldDocumentation = getImportantActionFieldDocumentation;
exports.IMPORTANT_ACTION_TYPES = [
    'action_type_alert',
    'action_type_interaction',
    'action_type_decision',
    'action_type_scheme',
];
exports.importantActionSchema = [
    // Basic Properties
    {
        name: 'type',
        type: 'enum',
        description: 'Type of important action.',
        values: [...exports.IMPORTANT_ACTION_TYPES],
...
exports.importantActionSchemaMap = new Map(exports.importantActionSchema.map((field) => [field.name, field]));
function getImportantActionFieldNames() {
    return exports.importantActionSchema.map((field) => field.name);
}
function getImportantActionFieldDocumentation(fieldName) {
    const field = exports.importantActionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=importantActionSchema.js.map