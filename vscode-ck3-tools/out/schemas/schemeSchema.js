...
exports.schemeSchemaMap = exports.schemeSchema = exports.SCHEME_SKILLS = exports.SCHEME_CATEGORIES = void 0;
exports.getSchemeFieldNames = getSchemeFieldNames;
exports.getSchemeFieldDocumentation = getSchemeFieldDocumentation;
exports.SCHEME_CATEGORIES = [
    'hostile',
    'personal',
    'friendly',
...
exports.schemeSchema = [
    // Basic Properties
    {
        name: 'skill',
        type: 'enum',
        description: 'The skill used for this scheme.',
        values: [...exports.SCHEME_SKILLS],
        required: true,
    ...
    },
    {
        ...
        values: [...exports.SCHEME_CATEGORIES],
...
exports.schemeSchemaMap = new Map(exports.schemeSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getSchemeFieldNames() {
    return exports.schemeSchema.map((field) => field.name);
}
// Get documentation for a field
function getSchemeFieldDocumentation(fieldName) {
    const field = exports.schemeSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=schemeSchema.js.map