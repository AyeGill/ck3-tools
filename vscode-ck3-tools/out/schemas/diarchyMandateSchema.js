...
exports.diarchyMandateSchemaMap = exports.diarchyMandateSchema = void 0;
exports.getDiarchyMandateFieldNames = getDiarchyMandateFieldNames;
exports.getDiarchyMandateFieldDocumentation = getDiarchyMandateFieldDocumentation;
exports.diarchyMandateSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.diarchyMandateSchemaMap = new Map(exports.diarchyMandateSchema.map((field) => [field.name, field]));
function getDiarchyMandateFieldNames() {
    return exports.diarchyMandateSchema.map((field) => field.name);
}
function getDiarchyMandateFieldDocumentation(fieldName) {
    const field = exports.diarchyMandateSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=diarchyMandateSchema.js.map