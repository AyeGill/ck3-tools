...
exports.scriptedAnimationSchemaMap = exports.scriptedAnimationSchema = void 0;
exports.getScriptedAnimationFieldNames = getScriptedAnimationFieldNames;
exports.getScriptedAnimationFieldDocumentation = getScriptedAnimationFieldDocumentation;
exports.scriptedAnimationSchema = [
    // Basic Properties
    {
        name: 'animation',
        type: 'string',
...
exports.scriptedAnimationSchemaMap = new Map(exports.scriptedAnimationSchema.map((field) => [field.name, field]));
function getScriptedAnimationFieldNames() {
    return exports.scriptedAnimationSchema.map((field) => field.name);
}
function getScriptedAnimationFieldDocumentation(fieldName) {
    const field = exports.scriptedAnimationSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=scriptedAnimationSchema.js.map