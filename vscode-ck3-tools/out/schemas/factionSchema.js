...
exports.factionSchemaMap = exports.factionSchema = exports.FACTION_TYPES = void 0;
exports.getFactionFieldNames = getFactionFieldNames;
exports.getFactionFieldDocumentation = getFactionFieldDocumentation;
exports.FACTION_TYPES = [
...
exports.factionSchemaMap = new Map(exports.factionSchema.map((field) => [field.name, field]));
function getFactionFieldNames() {
    return exports.factionSchema.map((field) => field.name);
}
function getFactionFieldDocumentation(fieldName) {
    const field = exports.factionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=factionSchema.js.map