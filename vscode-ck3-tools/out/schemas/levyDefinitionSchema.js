...
exports.levyDefinitionSchemaMap = exports.levyDefinitionSchema = void 0;
exports.getLevyDefinitionFieldNames = getLevyDefinitionFieldNames;
exports.getLevyDefinitionFieldDocumentation = getLevyDefinitionFieldDocumentation;
exports.levyDefinitionSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.levyDefinitionSchemaMap = new Map(exports.levyDefinitionSchema.map((field) => [field.name, field]));
function getLevyDefinitionFieldNames() {
    return exports.levyDefinitionSchema.map((field) => field.name);
}
function getLevyDefinitionFieldDocumentation(fieldName) {
    const field = exports.levyDefinitionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=levyDefinitionSchema.js.map