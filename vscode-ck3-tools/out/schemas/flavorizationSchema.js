...
exports.flavorizationSchemaMap = exports.flavorizationSchema = exports.FLAVORIZATION_PRIORITY = exports.FLAVORIZATION_TYPES = void 0;
exports.getFlavorizationFieldNames = getFlavorizationFieldNames;
exports.getFlavorizationFieldDocumentation = getFlavorizationFieldDocumentation;
exports.FLAVORIZATION_TYPES = [
    'character',
    'title',
    'province',
    'faith',
...
exports.FLAVORIZATION_PRIORITY = [
    '1',
    '10',
    '20',
    '50',
...
exports.flavorizationSchema = [
    // Type and Priority
    {
        name: 'type',
        type: 'enum',
        description: 'The scope type this flavorization applies to.',
        values: [...exports.FLAVORIZATION_TYPES],
...
exports.flavorizationSchemaMap = new Map(exports.flavorizationSchema.map((field) => [field.name, field]));
function getFlavorizationFieldNames() {
    return exports.flavorizationSchema.map((field) => field.name);
}
function getFlavorizationFieldDocumentation(fieldName) {
    const field = exports.flavorizationSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=flavorizationSchema.js.map