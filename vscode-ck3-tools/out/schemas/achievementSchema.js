...
exports.achievementSchemaMap = exports.achievementSchema = void 0;
exports.getAchievementFieldNames = getAchievementFieldNames;
exports.getAchievementFieldDocumentation = getAchievementFieldDocumentation;
...
exports.achievementSchemaMap = new Map(exports.achievementSchema.map((field) => [field.name, field]));
function getAchievementFieldNames() {
    return exports.achievementSchema.map((field) => field.name);
}
function getAchievementFieldDocumentation(fieldName) {
    const field = exports.achievementSchemaMap.get(fieldName);
    if (!field)
        return undefined;
