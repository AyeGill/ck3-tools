...
exports.scriptValueSchemaMap = exports.scriptValueSchema = void 0;
exports.getScriptValueFieldNames = getScriptValueFieldNames;
exports.getScriptValueFieldDocumentation = getScriptValueFieldDocumentation;
exports.scriptValueSchema = [
...
exports.scriptValueSchemaMap = new Map(exports.scriptValueSchema.map((field) => [field.name, field]));
function getScriptValueFieldNames() {
    return exports.scriptValueSchema.map((field) => field.name);
}
function getScriptValueFieldDocumentation(fieldName) {
    const field = exports.scriptValueSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=scriptValueSchema.js.map