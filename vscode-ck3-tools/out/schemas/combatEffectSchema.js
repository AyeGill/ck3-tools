...
exports.combatEffectSchemaMap = exports.combatEffectSchema = void 0;
exports.getCombatEffectFieldNames = getCombatEffectFieldNames;
exports.getCombatEffectFieldDocumentation = getCombatEffectFieldDocumentation;
exports.combatEffectSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.combatEffectSchemaMap = new Map(exports.combatEffectSchema.map((field) => [field.name, field]));
function getCombatEffectFieldNames() {
    return exports.combatEffectSchema.map((field) => field.name);
}
function getCombatEffectFieldDocumentation(fieldName) {
    const field = exports.combatEffectSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=combatEffectSchema.js.map