...
exports.characterBackgroundSchemaMap = exports.characterBackgroundSchema = void 0;
exports.getCharacterBackgroundFieldNames = getCharacterBackgroundFieldNames;
exports.getCharacterBackgroundFieldDocumentation = getCharacterBackgroundFieldDocumentation;
exports.characterBackgroundSchema = [
    // Basic Properties
    {
        name: 'background',
        type: 'string',
...
exports.characterBackgroundSchemaMap = new Map(exports.characterBackgroundSchema.map((field) => [field.name, field]));
function getCharacterBackgroundFieldNames() {
    return exports.characterBackgroundSchema.map((field) => field.name);
}
function getCharacterBackgroundFieldDocumentation(fieldName) {
    const field = exports.characterBackgroundSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=characterBackgroundSchema.js.map