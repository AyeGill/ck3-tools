...
exports.coaPatternSchemaMap = exports.coaPatternSchema = void 0;
exports.getCoaPatternFieldNames = getCoaPatternFieldNames;
exports.getCoaPatternFieldDocumentation = getCoaPatternFieldDocumentation;
exports.coaPatternSchema = [
    // Basic Properties
    {
        name: 'name',
        type: 'string',
...
exports.coaPatternSchemaMap = new Map(exports.coaPatternSchema.map((field) => [field.name, field]));
function getCoaPatternFieldNames() {
    return exports.coaPatternSchema.map((field) => field.name);
}
function getCoaPatternFieldDocumentation(fieldName) {
    const field = exports.coaPatternSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=coaPatternSchema.js.map