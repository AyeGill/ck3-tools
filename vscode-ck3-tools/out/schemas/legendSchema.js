...
exports.legendSchemaMap = exports.legendSchema = exports.LEGEND_TYPES = void 0;
exports.getLegendFieldNames = getLegendFieldNames;
exports.getLegendFieldDocumentation = getLegendFieldDocumentation;
exports.LEGEND_TYPES = [
    'heroic',
    'holy',
    'legitimizing',
];
exports.legendSchema = [
    // Basic Properties
    {
        name: 'type',
        type: 'enum',
        description: 'Type of legend.',
        values: [...exports.LEGEND_TYPES],
        example: 'type = heroic',
    },
    {
        name: 'quality',
...
exports.legendSchemaMap = new Map(exports.legendSchema.map((field) => [field.name, field]));
function getLegendFieldNames() {
    return exports.legendSchema.map((field) => field.name);
}
function getLegendFieldDocumentation(fieldName) {
    const field = exports.legendSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=legendSchema.js.map