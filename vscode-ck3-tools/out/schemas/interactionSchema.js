...
exports.interactionSchemaMap = exports.interactionSchema = exports.AI_RECIPIENT_TYPES = exports.GREETING_TYPES = exports.INTERACTION_CATEGORIES = void 0;
exports.getInteractionFieldNames = getInteractionFieldNames;
exports.getInteractionFieldDocumentation = getInteractionFieldDocumentation;
exports.INTERACTION_CATEGORIES = [
...
exports.GREETING_TYPES = [
    'positive',
    'negative',
    'neutral',
];
exports.AI_RECIPIENT_TYPES = [
    'all',
    'neighboring_rulers',
    'realm_characters',
    'courtiers',
...
exports.interactionSchema = [
    // Basic Properties
    {
        name: 'category',
        type: 'enum',
        description: 'UI category for the interaction.',
        values: [...exports.INTERACTION_CATEGORIES],
...
exports.interactionSchemaMap = new Map(exports.interactionSchema.map((field) => [field.name, field]));
// Get all field names for completion
function getInteractionFieldNames() {
    return exports.interactionSchema.map((field) => field.name);
}
// Get documentation for a field
function getInteractionFieldDocumentation(fieldName) {
    const field = exports.interactionSchemaMap.get(fieldName);
    if (!field)
        return undefined;
...
//# sourceMappingURL=interactionSchema.js.map