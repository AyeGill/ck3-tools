...
export const imperialAdministrationSchema: FieldSchema[] = [
  // Basic Properties
  {
    name: 'name',
    type: 'string',
...
export const imperialAdministrationSchemaMap = new Map<string, FieldSchema>(
  imperialAdministrationSchema.map((field) => [field.name, field])
);

export function getImperialAdministrationFieldNames(): string[] {
  return imperialAdministrationSchema.map((field) => field.name);
}

export function getImperialAdministrationFieldDocumentation(fieldName: string): string | undefined {
  const field = imperialAdministrationSchemaMap.get(fieldName);
