...
export const characterTriggers: TriggerDefinition[] = [
  ...
  { name: 'can_create_faction', description: 'can the character create the faction of the specified type against the specified character?', supportedScopes: ['character'], syntax: "can_create_faction = { type = X target = Y }", parameters: ['type'] },
  ...
  { name: 'can_start_scheme', description: 'can the character start the scheme?', supportedScopes: ['character'], syntax: "can_start_scheme = { type = X target = Y }", parameters: ['type'] },
  ...
  { name: 'diplomacy_diff', description: 'does the character have the required diplomacy skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "diplomacy = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['diplomacy', 'target'] },
  ...
  { name: 'has_domicile_temperament_high', description: 'Does scoped character have domicile temperament high?', supportedScopes: ['character'], valueType: 'boolean', syntax: "scope:character = { has_temperament_high = yes }", parameters: ['has_temperament_high'] },
  { name: 'has_domicile_temperament_low', description: 'Does scoped character have domicile temperament low?', supportedScopes: ['character'], valueType: 'boolean', syntax: "scope:character = { has_temperament_low = yes }", parameters: ['has_temperament_low'] },
  { name: 'has_domicile_temperament_neutral', description: 'Does scoped character have domicile temperament neutral?', supportedScopes: ['character'], valueType: 'boolean', syntax: "scope:character = { has_temperament_neutral = yes }", parameters: ['has_temperament_neutral'] },
  ...
  { name: 'has_election_vote_of', description: 'Is the target character voting for the scoped character in the election of the target title', supportedScopes: ['character'], syntax: "has_election_vote_of = { who = scope:actor title = primary_title }", parameters: ['who'] },
  ...
  { name: 'has_subject_contract_group', description: 'Check if the character has a specific contract group', supportedScopes: ['character'], syntax: "scope:actor = { has_contract_group = { contract_group = <key> } }", parameters: ['has_contract_group', 'contract_group'] },
  ...
  { name: 'intrigue_diff', description: 'does the character have the required intrigue skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "intrigue = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['intrigue', 'target'] },
  ...
  { name: 'learning_diff', description: 'does the character have the required learning skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "learning = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['learning', 'target'] },
  ...
  { name: 'martial_diff', description: 'does the character have the required martial skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "martial = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['martial', 'target'] },
  ...
  { name: 'number_of_commander_traits_in_common', description: 'does the character and the target have a number of commander traits in common?', supportedScopes: ['character'], syntax: "number_of_personality_traits_in_common = { target = X value >/</>=/<= Y }", parameters: ['number_of_personality_traits_in_common', 'target'] },
  ...
  { name: 'number_of_election_votes', description: 'Check the number of votes the scoped character has in the target title', supportedScopes: ['character'], valueType: 'comparison', syntax: "number_of_election_votes = { title = scope:actor.primary_title value = 0 }", parameters: ['title'] },
  ...
  { name: 'number_of_opposing_personality_traits', description: 'does the character and the target have a number of opposing personality traits?', supportedScopes: ['character'], syntax: "number_of_opposing_personality_traits = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  { name: 'number_of_opposing_traits', description: 'does the character and the target have a number of opposing traits?', supportedScopes: ['character'], syntax: "number_of_opposing_traits = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  ...
  { name: 'number_of_personality_traits_in_common', description: 'does the character and the target have a number of personality traits in common?', supportedScopes: ['character'], syntax: "number_of_personality_traits_in_common = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  ...
  { name: 'number_of_sinful_traits_in_common', description: 'do the two characters share a number of traits that is considered sinful by both of their respective faiths?', supportedScopes: ['character'], valueType: 'comparison', syntax: "number_of_sinful_traits_in_common = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  ...
  { name: 'number_of_traits_in_common', description: 'does the character and the target have a number of traits in common?', supportedScopes: ['character'], syntax: "number_of_traits_in_common = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  ...
  { name: 'number_of_virtue_traits_in_common', description: 'do the two characters share a number of traits that is considered virtuous by both of their respective faiths?', supportedScopes: ['character'], valueType: 'comparison', syntax: "number_of_virtue_traits_in_common = { target = X value >/</>=/<= Y }", parameters: ['target'] },
  ...
  { name: 'player_heir_position', description: 'Check where the target character is in the scoped character\'s player heir list.', supportedScopes: ['character'], valueType: 'comparison', syntax: "player_heir_position = { target = scope:actor position = 0 }", parameters: ['target'] },
  ...
  { name: 'prowess_diff', description: 'does the character have the required prowess skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "prowess = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['prowess', 'target'] },
  ...
  { name: 'stewardship_diff', description: 'does the character have the required stewardship skill level difference against target?', supportedScopes: ['character'], valueType: 'comparison', syntax: "stewardship = { target = character value <= script_value abs = yes/no(optional, default no) }", parameters: ['stewardship', 'target'] },
  ...
  { name: 'time_to_hook_expiry', description: 'The # of days until the scoped character\'s hook on the target expires', supportedScopes: ['character'], valueType: 'comparison', syntax: "time_to_hook_expiry = { target = someone value > 50 }", parameters: ['target'] },
...
export const landedtitleTriggers: TriggerDefinition[] = [
  ...
  { name: 'can_title_create_faction', description: 'can the title create the faction of the specified type against the specified character?', supportedScopes: ['landed_title'], syntax: "can_title_create_faction = { type = X target = Y }", parameters: ['type'] },
...
export const generalTriggers: TriggerDefinition[] = [
  ...
  { name: 'calc_true_if', description: 'Returns true if the specified number of sub-triggers return true', supportedScopes: ['none'], syntax: "calc_true_if = { amount = 2 <trigger> <trigger> <trigger> }", parameters: ['amount'] },
  ...
  { name: 'save_temporary_opinion_value_as', description: 'Saves the scoped character\'s opinion of the target character as an arbitrarily-named target to be referenced later in the in the same trigger', supportedScopes: ['none'], syntax: "save_temporary_opinion_value_as = { name = <string> target = x", parameters: ['name', 'target'] },
  ...
  { name: 'save_temporary_scope_value_as', description: 'Saves a numerical or bool value as an arbitrarily-named temporary target to be referenced later in the same effect', supportedScopes: ['none'], syntax: "save_temporary_scope_value_as = { name = <string> value = x }", parameters: ['name'] },
  ...
  { name: 'weighted_calc_true_if', description: 'Returns true if the sum of weights of fulfilled sub-triggers amount to the specified sum', supportedScopes: ['none'], syntax: "weighted_calc_true_if = { amount = 10 5 = { <trigger> } 15 = { <trigger> } 7 = { <trigger> } }", parameters: ['amount'] },
