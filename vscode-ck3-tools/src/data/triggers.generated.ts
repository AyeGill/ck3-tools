...
export const generalTriggers: TriggerDefinition[] = [
  ...
  { name: 'save_temporary_opinion_value_as', description: 'Saves the scoped character\'s opinion of the target character as an arbitrarily-named target to be referenced later in the in the same trigger', supportedScopes: ['none'], syntax: "save_temporary_opinion_value_as = { name = <string> target = x", parameters: ['name'] },
