...
export interface TriggerDefinition {
  ...
  supportedTargets?: ScopeType[];  // For targeting triggers
  outputScope?: ScopeType;         // For scope-changing triggers
  isIterator?: boolean;            // e.g., any_vassal
  valueType?: 'boolean' | 'comparison' | 'block';  // How it's used
  syntax?: string;
}
 ...
 */
export const iteratorTriggers: TriggerDefinition[] = [
 ...
 * Logical triggers
 */
export const logicalTriggers: TriggerDefinition[] = [
 ...
 */
export const scopeChangeTriggers: TriggerDefinition[] = [
 ...
 * Special triggers
 */
export const specialTriggers: TriggerDefinition[] = [
