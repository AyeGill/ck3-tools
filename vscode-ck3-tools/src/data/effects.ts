...
export interface EffectDefinition {
  ...
  supportedTargets?: ScopeType[];  // For targeting effects
  outputScope?: ScopeType;         // For scope-changing effects
  isIterator?: boolean;            // e.g., every_vassal, random_vassal
  syntax?: string;                 // Usage example
}
 ...
 */
export const iteratorEffects: EffectDefinition[] = [
  // Character iterators
 ...
 */
export const controlFlowEffects: EffectDefinition[] = [
 ...
 */
export const scopeChangeEffects: EffectDefinition[] = [
